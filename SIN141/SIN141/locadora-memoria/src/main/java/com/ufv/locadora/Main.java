...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Caminhonete caminhonete = new Caminhonete("GON0113", "Chevrolet", "Dodege ram", 2025, 200.00, 4, "FLEX", 1000);
        ...
        Cliente Guilherme = new Cliente("Guilherme", "12345678918", "guilherme@email.com");

        clienteServico.salvar(maria);
        clienteServico.salvar(joao);
        clienteServico.salvar(Guilherme);
        ...
        Locacao locacaoCaminhonete = locacaoServico.realizar(
                Guilherme.getId(), caminhonete.getId(), hoje, daqui5dias);
        System.out.println("Locacao diaria: " + locacaoCaminhonete);
